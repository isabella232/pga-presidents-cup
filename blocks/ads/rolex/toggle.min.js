...
var dim = {width: 180, height: 180, scale: .97};// scale 0.75
 ...
 */
var needlesFolder = './toggle/img/';// deprecated
...
var clockSettings = {
    ...
    trackingurl: 'https://www.rolex.com/?cmpid=dsp_Clock_pgatour.com_rlx1901680', /* set the tracking url */
    trackingPixel: '',
...
//             };
            ...
            function cityTime(thenewOffset, customOffset, elem) {
                ...
                if (language === "en" || language === "kr") clockSettings.amPm = true; clockSettings.time24hours = false
